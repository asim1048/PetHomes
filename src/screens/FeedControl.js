...
export default function FeedControl({ navigation }) {
  ...
  const sendData = async () => {
    ...
    //year
    fetch(`http://${ip}/feedYear?value=${year}`, {
      method: 'POST',
    })
      .then(response => {
    ...
    //month
    fetch(`http://${ip}/feedMonth?value=${month}`, {
      method: 'POST',
    })
      .then(response => {
        console.log(response);
    ...
    //date
    fetch(`http://${ip}/feedDate?value=${day}`, {
      method: 'POST',
    })
      .then(response => {
        console.log(response);
    ...
    //hour
    fetch(`http://${ip}/feedHour?value=${hour}`, {
      method: 'POST',
    })
      .then(response => {
        console.log(response);
    ...
    //min
    fetch(`http://${ip}/feedMin?value=${min}`, {
      method: 'POST',
    })
      .then(response => {
        console.log(response);
          ...
          <View style={{
            ...
            <View style={{
              ...
              <Text style={{
                ...
                fontWeight: 'bold',
                opacity: 1
              }}>Control Your Aquarium Feed</Text>
              {/* <Text style={{
                marginTop: 20,
                color: 'yellow',
                fontSize: 25,
